...
const WelcomeSection = () => {
  return (
    <div className="container-width container-px relative  before:absolute before:bottom-0 before:right-0 before:bg-primary-color before:blur-[700px] before:w-100 before:h-100 transition-all duration-300">
